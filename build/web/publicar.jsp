                    ...
                    <c:if test="${sessionScope.user!=null}">
                        ...
                        <div id="page-wrapper" >
                            <div id="page-inner">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 style="font-family: 'Chewy', cursive;">Publicar Nuevo Artículo</h2>   
                                ...
                                <section  style="margin-bottom: 100px; margin-top: 1%;">     
                                    ...
                                    <form id="f2"  onsubmit="return validarPublicacion();" enctype="multipart/form-data" method="POST" action="/COQUEBA/controlador/validar_articulo" style="margin-left: 5%;">
                                        <section class="container-fluid">                  
                                            <fieldset class="col-sm-6">

                                                <span style="color: red;" id="spanNameART"></span>  
                                                <div class="form-group input-group" id="div_art_nombre">                   
                                                ...
                                                <span style="color: red;" id="spanCpART"></span>  
                                                <div class="form-group input-group" id="div_art_cp">                   
                                                ...
                                                <span style="color: red;" id="spanPrecioART"></span>  
                                                <div class="form-group input-group" id="div_art_precio">                   
                                                    <span class="glyphicon glyphicon-euro input-group-addon"></span>
                                                    <input style="margin-top: 2px;" type="text" class="form-control" id="precio" placeholder="Precio" pattern="^(\d|-)?(\d|,)*\.?\d*$" title="Formato incorrecto" name="precio"></div>
                                                ...
                                                <div class="form-group input-group">                   
                                                    ...
                                                    <span style="color: red;" id="spanImagenART"></span>  
                                                    <div class="form-group" id="div_art_foto">
                                                        <label>Imagen del artículo</label>
                                                        <input name="file1" type="file" id="adjuntar" accept="image/png,image/jpg,image/jpeg">
                                                    </div>
